...
export default function Sidebar({ searchValue, setSearchValue, setSearchDescr, onClickFavoritListBtn}) {
	...
	return (
		<div className="sidebar">
			<search role="search" className='search'>
				<input type="text" className="search__input" placeholder='Поиск радио' value={searchValue} onChange={(evt) => setSearchValue(evt.target.value)} />
				<button onClick={onSubmitSearch} className="search__submit-btn">
			...
			<div className="sidebar__menu-list">
				<button onClick={onClickMain} className="menu-dialog-item active">
