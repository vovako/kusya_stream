...
function Search({ value, setValue, isActive, onSubmitSearch }) {
	...
	return (
		<search role="search" className={isActive ? 'search' : 'search invisible'}>
			<input type="text" className="search__input" placeholder='Поиск радио' ref={inputRef} value={value} onChange={(evt) => setValue(evt.target.value)} />
